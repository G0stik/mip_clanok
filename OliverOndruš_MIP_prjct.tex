...
%.(Postupom času možno pridam dalsie sekcie atd)
\end{figure*}
...
%Sportovec
%(Instalater / equpiment manager)

\subsection{Adaptovatelné tréningy mimo VR}    		%%%%%% okrem tohoto , tiež rozpracované 
...
%predtym než ideš piť sa najedz
